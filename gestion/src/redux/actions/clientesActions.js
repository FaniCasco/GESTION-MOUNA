...
} from './actionTypes'; // Asegúrate que estos nuevos tipos estén definidos aquí

// URL base de tu API backend
// En clientesActions.js
...
    });
    ...
    dispatch(getClientes());
    // Opcional: si estás viendo el detalle, recargarlo también
    // dispatch(getClienteDetailsById(clienteId));
...
    });
    // La lista se actualizará si el reducer maneja DELETE_CLIENTE_SUCCESS correctamente
    // eliminando el cliente del estado 'clientes'.
...
// Nota: Necesitarás asegurar que tu reducer de clientes maneje los nuevos tipos de acciones (GET_CLIENTE_BY_ID_...)
// para almacenar el cliente individual y su estado de carga/error.